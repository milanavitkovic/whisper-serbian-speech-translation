...
Original file is located at
    https://colab.research.google.com/drive/1INZ_s_w6Nqef3HFlONfux-IEKKQsceSq
"""

"""
Serbian → English Speech Translation Evaluation Script
...
def load_test_data(
    ...
    """
    print(f"📂 Loading Serbian transcripts from: {sr_file}")
    print(f"📂 Loading English translations from: {en_file}")
    print(f"📁 Audio folder: {audio_base_path}")
...
def calculate_overall_metrics(predictions: list, references: list) -> dict:
    ...
    try:
        ...
        print(f"⚠️  Error calculating WER: {e}")
        metrics['WER'] = None
    ...
    try:
        ...
        try:
            ...
            if meteor_scores:
                ...
                metrics['METEOR'] = None
                print(f"⚠️  Could not calculate METEOR")
        except Exception as e2:
            print(f"⚠️  METEOR calculation failed: {e2}")
            metrics['METEOR'] = None
...
def evaluate_model(
    ...
    for i in tqdm(range(num_samples)):
        try:
            ...
            # Configure for Serbian → English translation
...
def analyze_results(results_df: pd.DataFrame):
    ...
    print("\n✅ TOP 5 BEST EXAMPLES (highest BLEU):")
    ...
    print("\n\n❌ TOP 5 WORST EXAMPLES (lowest BLEU):")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate Whisper Serbian→English translation")
    ...
    # Setup
    print("=" * 70)
    print("Serbian → English Speech Translation - Evaluation")
    print("=" * 70)
    ...
    print("\n✅ Evaluation complete!")
    print(f"📁 Results: {os.path.join(args.output_dir, 'evaluation_results.csv')}")
    print(f"📊 Plots: {plot_output}")
